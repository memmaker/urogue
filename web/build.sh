#!/bin/sh
# Build UltraRogue for the browser (Emscripten + Asyncify) into web/dist;
...
cp web/index.html "$HOME/Games/rvip-tools/web/rvip-wm.js" web/urogue.js port/tiles.png port/tiles-dawn.png "$OUT/"
